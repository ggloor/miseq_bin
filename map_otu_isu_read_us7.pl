...
#H	0	253	100.0	+	0	0	253M	lcl|35|num|55975	lcl|35;size=55975
#H	2	253	100.0	+	0	0	253M	lcl|99|num|18826	lcl|99;size=18826
#H	8291	252	97.2	+	0	0	252M	lcl|49|num|12978	lcl|395893;size=1
#N	*	*	*	.	*	*	*	lcl|6953|num|203	*
...
open (IN, "< $read_file") or die;
	while(defined(my $l = <IN>)){
		...
		my @l = split/[\@\t]/, $l;
		my $d1 = "";
		if (exists $isu{$l[1]}){ #don't print singleton reads
			$d1 = "$l[1]$isu{$l[1]}";
			#print "$l[1] \n "; 
			@l = split/\t/, $l;
			my $l = @l -1;
